...
//  Object.assign(AnimationClip, {
      ...
      public static CreateFromMorphTargetSequence(name, morphTargetSequence, fps, noLoop) {
      ...
      public static findByName(objectOrClipArray, name) {
      ...
      public static parseAnimation(animation, bones) {
         if (!animation) {
