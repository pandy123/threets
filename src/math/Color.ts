      ...
      export class Color {
            ...
            constructor(r?: any, g?: number, b?: number) {
                  ...
                  if (g === undefined && b === undefined) {
                        ...
                        this.setRGB(r, g as any, b as any);
                  }
            }
            ...
            public setStyle(style: any) {
                  ...
                  if (style && style.length > 0) {
                        ...
                        // color keywords
                        hex = (ColorKeywords as any)[style];

                        if (hex !== undefined) {

                              // red
                              this.setHex(hex as any);
            ...
            public copyGammaToLinear(color: Color, gammaFactor: number) {
            ...
            public copyLinearToGamma(color: Color, gammaFactor: number) {
            ...
            public convertGammaToLinear(gammaFactor: number) {
            ...
            public convertLinearToGamma(gammaFactor: number) {
            ...
            public offsetHSL(h: number, s: number, l: number) {
                  var hsl = {} as any;
                  this.getHSL(hsl);
            ...
            public addColors(color1: Color, color2: Color) {
            ...
            public lerp(color: Color, alpha: number) {
