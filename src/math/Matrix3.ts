module THREE {
   export class Matrix3 {
      ...
      public applyToBufferAttribute(attribute: any): any {
         //TODO:
         var v1 = new Vector3();
      ...
      public multiply(m: any): Matrix3 {
         return this.multiplyMatrices(this, m);
      }

      public premultiply(m: any): Matrix3 {
         return this.multiplyMatrices(m, this);
      }

      public multiplyMatrices(a: any, b: any): Matrix3 {
         var ae = a.elements;
         var be = b.elements;
         var te = this.elements;
      ...
      public getInverse(matrix, throwOnDegenerate?: boolean) {
      ...
      public transposeIntoArray(r: any): Matrix3 {
         var m = this.elements;
         r[0] = m[0];
         r[1] = m[3];
         r[2] = m[6];
      ...
      public setUvTransform(tx: number, ty: number, sx: number, sy: number, rotation: number, cx: number, cy: number) {
      ...
      public fromArray(array: Array<number>, offset?: number): Matrix3 {
      ...
      public toArray(array: Array<number>, offset: number): any {
