module THREE {
    export class Matrix4 {
        ...
        public extractBasis(xAxis, yAxis, zAxis): Matrix4 {
        ...
        public makeBasis(xAxis, yAxis, zAxis): Matrix4 {
            this.set(
        ...
        public multiply(m: Matrix4, n?: Matrix4): Matrix4 {
            if (n !== undefined) {
        ...
        public makeRotationAxis(axis: any, angle: any): Matrix4 {
        ...
        public fromArray(array: any, offset?: number): Matrix4 {
        ...
        public toArray(array?: any, offset?: number): any {
