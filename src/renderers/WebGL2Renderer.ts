module THREE {
    export class WebGL2Renderer {
        ...
        public gl: any;
        public attributes: any;// { alpha: any; depth: any; stencil: any; antialias: any; premultipliedAlpha: any; preserveDrawingBuffer: any; powerPreference: any; };
        private _autoClear: boolean;
        private _autoClearColor: boolean;
        private _autoClearDepth: boolean;
        private _autoClearStencil: boolean;
        ...
        constructor(parameters) {
            ...
            this.extensions = new WebGLExtensionsNode(this.gl);
            this.state = new WebGLStateNode(this.gl, this.extensions, function () { });
        }
        //
