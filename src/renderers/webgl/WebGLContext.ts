module THREE {
    export class WebGLContext {
        ...
        public uniform1fv(location: WebGLUniformLocation, v: Float32Array | ArrayLike<number>) {
            this.gl.uniform1fv(location, v);
        }
        public uniform1i(location: WebGLUniformLocation, x: number) {
            this.gl.uniform1i(location, x);
        }
        public uniform1iv(location: WebGLUniformLocation, v: Int32Array | ArrayLike<number>) {
            this.gl.uniform1iv(location, v);
        }
        public uniform2f(location: WebGLUniformLocation, x: number, y: number) {
            this.gl.uniform2f(location, x, y);
        }
        public uniform2fv(location: WebGLUniformLocation, v: Float32Array | ArrayLike<number>) {
        ...
        public uniform2iv(location: WebGLUniformLocation, v: Int32Array | ArrayLike<number>) {
            this.gl.uniform2iv(location, v);
        }
        public uniform3f(location: WebGLUniformLocation, x: number, y: number, z: number) {
            this.gl.uniform3f(location, x, y, z);
        }
        public uniform3fv(location: WebGLUniformLocation, v: Float32Array | ArrayLike<number>) {
        ...
        public uniform3iv(location: WebGLUniformLocation, v: Int32Array | ArrayLike<number>) {
            this.gl.uniform3iv(location, v);
        }
        public uniform4f(location: WebGLUniformLocation, x: number, y: number, z: number, w: number) {
            this.gl.uniform4f(location, x, y, z, w);
        }
        public uniform4fv(location: WebGLUniformLocation, v: Float32Array | ArrayLike<number>) {
        ...
        public uniform4iv(location: WebGLUniformLocation, v: Int32Array | ArrayLike<number>) {
            this.gl.uniform4iv(location, v);
        }
        public uniformMatrix2fv(location: WebGLUniformLocation, transpose: boolean, value: Float32Array | ArrayLike<number>) {
            this.gl.uniformMatrix2fv(location, transpose, value);
        }
        public uniformMatrix3fv(location: WebGLUniformLocation, transpose: boolean, value: Float32Array | ArrayLike<number>) {
            this.gl.uniformMatrix3fv(location, transpose, value);
        }
        public uniformMatrix4fv(location: WebGLUniformLocation, transpose: boolean, value: Float32Array | ArrayLike<number>) {
